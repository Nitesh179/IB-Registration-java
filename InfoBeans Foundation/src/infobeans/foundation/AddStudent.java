 ...
 PreparedStatement pst=null;
  JDateChooser dob;
    ...
    private void initComponents() {
        ...
        annual = new javax.swing.JComboBox<>();
        ...
        annual.setFont(new java.awt.Font("Calibri Light", 0, 18)); // NOI18N
        annual.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Please Select", "36000 - 100000", "100000 - 300000", "300000 above", " " }));
        annual.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                annualKeyPressed(evt);
            }
        });
        ...
        jPanel5Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel5Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            ...
                            .addGroup(jPanel5Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addComponent(mName, javax.swing.GroupLayout.DEFAULT_SIZE, 128, Short.MAX_VALUE)
                ...
                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(annual, javax.swing.GroupLayout.PREFERRED_SIZE, 129, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(26, 26, 26)
    ...
    private void SubmitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SubmitActionPerformed
        ...
        try{
            ...
            con=DriverManager.getConnection("jdbc:mysql://localhost:3306/infodb","root","nitesh"); 
            ...
            pst.setString(12,annual.getSelectedItem().toString());
...
fOcc.setText("");
mOcc.setText("");
annual.setSelectedItem("");
marrial.setSelectedItem("");
mobile.setText("");
email.setText("");
adhar.setText("");
sssm.setText("");
stream12th.setSelectedItem("");
per12.setText("");
ug.setSelectedItem("");
perUg.setText("");
pg.setSelectedItem("");
...
if(evt.getKeyCode()==KeyEvent.VK_ENTER)
   ...
   if(Character.isDigit(ch)&&s.length()==10)
   {
   ...
   else if(s.length()>10)
   {
       ...
       JOptionPane.showMessageDialog(null, "you have entered an invalid mobile no. please try again");
   }
   ...
   {  adhar.setBackground(Color.red);
        JOptionPane.showMessageDialog(null, "you have entered an invalid Adhar no. please try again");
   }  // TODO add your handling code here:
   ...
   String regex = "^(.+)@(.+)$";  
    ...
    private void sssmKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_sssmKeyReleased
   String s=sssm.getText();
   
   char ch=evt.getKeyChar();
    if(Character.isDigit(ch)&&s.length()==9)
   {
       sssm.setBackground(Color.WHITE);
   }
   else if(s.length()>9)
   {  sssm.setBackground(Color.red);
        JOptionPane.showMessageDialog(null, "you have entered an invalid SSSM Id No please try again");
   } 

        // TODO add your handling code here:
    }//GEN-LAST:event_sssmKeyReleased
 ...
 if(Character.isDigit(ch)){
     name.setBackground(Color.red);
       JOptionPane.showMessageDialog(null, "Number are not allow here!!");
 }
 else 
...
char ch=evt.getKeyChar();
 if(Character.isDigit(ch)){
     ...
     fName.setBackground(Color.white);        // TODO add your handling code here:
...
char ch=evt.getKeyChar();
 if(Character.isDigit(ch)){
     mName.setBackground(Color.red);
       JOptionPane.showMessageDialog(null, "Number are not allow here!!");
 }
 else 
     mName.setBackground(Color.white);        // TODO add your handling code here:
    }//GEN-LAST:event_mNameKeyReleased

    private void fOccKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_fOccKeyReleased
char ch=evt.getKeyChar();
 if(Character.isDigit(ch)){
     fOcc.setBackground(Color.red);
       JOptionPane.showMessageDialog(null, "Number are not allow here!!");
 }
 else 
     fOcc.setBackground(Color.white);        // TODO add your handling code here:
    }//GEN-LAST:event_fOccKeyReleased

    private void mOccKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_mOccKeyReleased
char ch=evt.getKeyChar();
 if(Character.isDigit(ch)){
    mOcc.setBackground(Color.red);
       JOptionPane.showMessageDialog(null, "Number are not allow here!!");
 }
 else 
     mOcc.setBackground(Color.white);        // TODO add your handling code here:
    }//GEN-LAST:event_mOccKeyReleased

    private void annualKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_annualKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_annualKeyPressed
...
if(evt.getKeyCode()==KeyEvent.VK_ENTER)  
    ...
    private javax.swing.JComboBox<String> annual;
